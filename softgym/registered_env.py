...
env_arg_dict = {
    ...
    'ClothFlattenGPTRGB':{ 'observation_mode': 'cam_rgb',
                        'action_mode': 'picker',
                        'num_picker': 1,
                        'picker_radius':0.01,
                        'render': True,
    ...
    'ClothFlattenGPTPC':{ 'observation_mode': 'point_cloud',
                        'action_mode': 'picker',
                        'num_picker': 1,
                        'picker_radius':0.02,
                        'render': True,
...
SOFTGYM_ENVS = OrderedDict({
    ...
    'ClothFlattenGPTRGB': ClothFlattenEnv,
    'ClothFlattenGPTPC': ClothFlattenEnv,
})
